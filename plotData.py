...
#pathToFile = 'logfile-20200814 18-40-18.txt'; comments = '1/? antennae on tablesaw and paint can'
#pathToFile = 'logfile-20200815 11-02-38.txt'; comments = '2/? antennae on tablesaw and paint can; first with real datetimes'
#pathToFile = 'logfile-20200816 10-11-21.txt'; comments = '3/? antennae on tablesaw and paint can; first with real datetimes'
#pathToFile = 'logfile-20200817 07-43-27.txt'; comments = '4/? antennae on tablesaw and paint can; first with real datetimes'

#pathToFile = 'logfile-20200817 19-26-06.txt'; comments = '1/? no external antennae'
#pathToFile = 'logfile-20200818 12-45-21.txt'; comments = '2/? no external antennae'
#pathToFile = 'logfile-20200819 11-59-43.txt'; comments = '3/? no external antennae'
#pathToFile = 'logfile-20200819 22-27-55.txt'; comments = '4/? no external antennae'
#pathToFile = 'logfile-20200821 09-26-18.txt'; comments = '5/? no external antennae'
#pathToFile = 'logfile-20200821 21-21-26.txt'; comments = '6/? no external antennae'

#pathToFile = 'logfile-20200822 10-06-56.txt'; comments = '1/? antennae on paint can & electrical panel'
#pathToFile = 'logfile-20200822 23-54-03.txt'; comments = '2/? antennae on paint can & electrical panel'
#pathToFile = 'logfile-20200823 11-54-14.txt'; comments = '3/? antennae on paint can & electrical panel'
pathToFile = 'logfile-20200824 00-10-26.txt'; comments = '4/? antennae on paint can & electrical panel'
